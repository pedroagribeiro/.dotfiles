...
LINUX_CONF_DIR="$HOME/.config/Cursor/User"
MACOS_CONF_DIR="$HOME/Library/Application\ Support/Cursor/User"
...
if [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    cp "$HOME/.dotfiles/vscode/settings.json" "/mnt/c/Users/Pedro\ Ribeiro/AppData/Roaming/Cursor/User/settings.json"
fi
